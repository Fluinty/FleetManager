...
export default async function VehiclesPage({
    ...
    let query = supabase
        .from('vehicles')
        .select('id, plate_number, brand, model, production_year, branch_id, next_inspection_date, next_insurance_date, is_active, is_leasing, financing_type, leasing_end_date, branches(name)')
