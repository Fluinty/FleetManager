...
export function TopVehiclesTable({ vehicles }: { vehicles: TopVehicle[] }) {
    return (
        <div className="rounded-xl md:rounded-2xl bg-gradient-to-br from-white/80 to-purple-50/50 backdrop-blur-xl border border-white/50 shadow-lg shadow-purple-500/5 overflow-hidden transition-all duration-300 hover:shadow-xl">
            <div className="p-4 md:p-6 border-b border-purple-100/50">
                <h3 className="text-base md:text-lg font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
